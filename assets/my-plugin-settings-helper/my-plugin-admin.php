...
if ( !defined('MY_PLUGIN_SETTINGS_PATH'))
    define( 'MY_PLUGIN_SETTINGS_PATH', dirname( __FILE__ ));
if ( !defined('MY_PLUGIN_SETTINGS_INC_PATH'))
    define( 'MY_PLUGIN_SETTINGS_INC_PATH', MY_PLUGIN_SETTINGS_PATH . '/inc' );
