 ...
 */
class My_Bootstrap_Menu_Settings_Admin extends My_Plugin_Settings_Admin
{
    /**
    ...
    function build_settings_nodes()
    {
        ...
        if (!$menus_and_theme_location_options) {
            $this->add_admin_notice('No Menus or Theme Locations exist, unable to continue!');
            return;
        }
        ...
        (
            ...
            My_Plugin_Settings_Node::withValues('include_div_for_fixed_top', 'Include div for fixed top', true, $this::section_advanced_options, My_Plugin_Settings_Input_Type::Checkbox, 'If selected this will include a fixed height div to move the content below the fixed top menu'),
