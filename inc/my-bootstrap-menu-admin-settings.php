    ...
    class My_Bootstrap_Menu_Admin_Settings extends My_Plugin_Settings_Admin
    {
        ...
        function build_settings_nodes()
        {
            ...
            (
                ...
                My_Plugin_Settings_Node::withValues('submenu_caret_icon', "Select Menu Dropdown Dashicon", null, $this::section_submenu_format, My_Plugin_Settings_Input_Type::Dashicon_Select, 'Icon to display if main menu item is enabled above'),
