    ...
    class My_Bootstrap_Menu_Admin_Settings extends My_Plugin_Settings_Admin
    {
        ...
        function build_settings_nodes()
        {
            ...
            (
                ...
                My_Plugin_Settings_Node::withValues('display_caret', "Display Dropdown Icon e.g. [<span class='dashicons dashicons-arrow-down'></span>]", true, $this::section_submenu_format, My_Plugin_Settings_Input_Type::Checkbox, 'Display icon if menu item has a submenu'),
                My_Plugin_Settings_Node::withValues('submenu_caret_icon', "Select Menu Dropdown Icon", 'dashicons dashicons-arrow-down', $this::section_submenu_format, My_Plugin_Settings_Input_Type::Dashicon_Select, 'Icon to display if main menu item is enabled above'),
